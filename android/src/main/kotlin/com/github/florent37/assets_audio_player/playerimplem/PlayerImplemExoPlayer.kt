        ...
        try {
            ...
            if (audioType == Player.AUDIO_TYPE_NETWORK || audioType == Player.AUDIO_TYPE_LIVESTREAM) {
                ...
                return when (type) {
                    ...
                    PlayerImplemTesterExoPlayer.Type.SmoothStreaming -> SsMediaSource.Factory(
                        factory
                    )
                ...
                val factory = ProgressiveMediaSource
                    .Factory(
                        DefaultDataSourceFactory(context, "assets_audio_player"),
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
                    ...
                    if (key != null) {
                        val sessionManager: DrmSessionManager = DefaultDrmSessionManager.Builder()
                            .setUuidAndExoMediaDrmProvider(
                                C.CLEARKEY_UUID,
                                FrameworkMediaDrm.DEFAULT_PROVIDER
                            ).build(LocalMediaDrmCallback(key.toByteArray()))
...
/* Configure the DefaultLoadControl to use the same value for */
    ...
    override suspend fun open(
        ...
        try {
            ...
            this.mediaPlayer?.addListener(object :
